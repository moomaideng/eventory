...
- **Backend (`backend/`):** Built with Go Huma v2 and GORM. Run `npm --prefix frontend run openapi:generate` from the repo root whenever API endpoints change to keep frontend types in sync.
