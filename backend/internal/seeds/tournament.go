...
func SeedTournaments(db *gorm.DB) error {
	...
	teams := []models.TournamentTeam{
		{ID: uuid.MustParse("44444444-0000-0000-0000-000000000001"), TournamentID: tournaments[0].ID, Name: "Neon Tigers", MemberCount: 5},
		{ID: uuid.MustParse("44444444-0000-0000-0000-000000000002"), TournamentID: tournaments[0].ID, Name: "Bangkok Byte", MemberCount: 5},
		{ID: uuid.MustParse("44444444-0000-0000-0000-000000000003"), TournamentID: tournaments[0].ID, Name: "Siam Sentinels", MemberCount: 5},
		{ID: uuid.MustParse("44444444-0000-0000-0000-000000000004"), TournamentID: tournaments[1].ID, Name: "Chula Phoenix", MemberCount: 6},
		{ID: uuid.MustParse("44444444-0000-0000-0000-000000000005"), TournamentID: tournaments[1].ID, Name: "River Guardians", MemberCount: 6},
		{ID: uuid.MustParse("44444444-0000-0000-0000-000000000006"), TournamentID: tournaments[1].ID, Name: "Lotus Legends", MemberCount: 6},
		{ID: uuid.MustParse("44444444-0000-0000-0000-000000000007"), TournamentID: tournaments[2].ID, Name: "Iron Fist BKK", MemberCount: 4},
		{ID: uuid.MustParse("44444444-0000-0000-0000-000000000008"), TournamentID: tournaments[2].ID, Name: "Manila Punishers", MemberCount: 4},
		{ID: uuid.MustParse("44444444-0000-0000-0000-000000000009"), TournamentID: tournaments[2].ID, Name: "Jakarta Kings", MemberCount: 4},
		{ID: uuid.MustParse("44444444-0000-0000-0000-000000000010"), TournamentID: tournaments[3].ID, Name: "Knight Owls", MemberCount: 4},
		{ID: uuid.MustParse("44444444-0000-0000-0000-000000000011"), TournamentID: tournaments[3].ID, Name: "Queen's Gambit Club", MemberCount: 4},
		{ID: uuid.MustParse("44444444-0000-0000-0000-000000000012"), TournamentID: tournaments[4].ID, Name: "Eventory Elite", MemberCount: 5},
		{ID: uuid.MustParse("44444444-0000-0000-0000-000000000013"), TournamentID: tournaments[4].ID, Name: "Northern Stars", MemberCount: 5},
		{ID: uuid.MustParse("44444444-0000-0000-0000-000000000014"), TournamentID: tournaments[4].ID, Name: "Crimson Circuit", MemberCount: 5},
	}
	if err := db.Clauses(clause.OnConflict{
